                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          CachedNetworkImage(
                                            ...
                                            key: UniqueKey(),
                                            imageUrl:
                                                "${ApiConfig.backDropImgUrl}${movieC.movieDetail?.backdropPath ?? ''}",
                                            fit: BoxFit.cover,
                                                      ...
                                                      Transform.scale(
                                                        ...
                                                        child: ClipRRect(
                                                          ...
                                                          child:
                                                            ...
                                                            key: UniqueKey(),
                                                            imageUrl:
                                                                "${ApiConfig.baseImgUrl}${movieC.movieDetail?.posterPath ?? ''}",
                                                            fit: BoxFit.contain,
                                                            placeholder:
                                                                (context,
                                                                        url) =>
                                                                      ...
                                                                      Wrap(
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          (index) {
                                                                            String?
                                                                                genre =
                                                                                movieC.movieDetail?.genres[index].name;
                                                                            return Padding(
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    ' ${movieC.movieDetail?.runtime.toString()} min',
                                                                    style: GoogleFonts
                                                                        .nunito(
                                                                      color: Colors
                                                                          .white,
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    ' ${movieC.movieDetail?.releaseDate.day.toString().padLeft(2, '0')}-${movieC.movieDetail?.releaseDate.month.toString().padLeft(2, '0')}-${movieC.movieDetail?.releaseDate.year.toString().padLeft(4, '0')}',
                                                                    style: GoogleFonts
                                                                        .nunito(
                                                                      color: Colors
                                                                          .white,
                                                              ...
                                                              LayoutBuilder(
                                                                builder: (context,
                                                                  ...
                                                                  const verticalSpacing =
                                                                      4.0;
                                                                  final itemCount =
                                                                      (movieC.movieDetail?.genres.length ??
                                                                              0)
                                                                          .clamp(
                                                                              0,
                                                                              6);
                                                                        ...
                                                                        children: [
                                                                          Wrap(
                                                                            ...
                                                                            children:
                                                                              ...
                                                                              itemCount,
                                                                              (index) {
                                                                                String? genre = movieC.movieDetail?.genres[index].name;
                                                                                return Padding(
                                                                                  padding: const EdgeInsets.only(bottom: verticalSpacing),
                                                                                  child: Container(
                                                                                    height: ResponsiveLayout.isMobile(context) ? 25 : 35,
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        movieC.movieDetail?.voteAverage.toStringAsFixed(1) ??
                                                                            '',
                                                                        style: GoogleFonts
                                                                            .nunito(
                                                                          color:
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      color: Theme.of(context)
                                          .appBarTheme
                                          .backgroundColor,
                                      child: movieC.movieCast.isEmpty
                                          ? const Center(
                                              child:
                                                  CircularProgressIndicator(),
                                            )
                                          : ListView.builder(
                                              ...
                                              itemCount:
                                                  movieC.movieCast.length <= 10
                                                      ? movieC.movieCast.length
                                                      : 10,
                                              itemBuilder: (context, index) {
                                                return CastCard(
                                                  imgUrl: ApiConfig.baseImgUrl +
                                                      movieC.movieCast[index]
                                                          .profilePath
                                                          .toString(),
                                                  castName: movieC
                                    ...
                                    SizedBox(
                                      height:
                                          ResponsiveLayout.isDesktop(context)
                                              ? 320
                                              : 300,
                                      child: movieC.similarMovies.isEmpty
                                          ? const Center(
                                              child:
                                                  CircularProgressIndicator(),
                                            )
